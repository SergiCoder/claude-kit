---
name: stack
description: Reviews code for language idioms, type safety, error handling, and framework best practices. Auto-detects stack from file extensions. Covers Python, TypeScript, Go, Django, Flask, FastAPI, Next.js, Nuxt, and SvelteKit.
---
